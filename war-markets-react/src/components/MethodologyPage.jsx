const card = { background: 'var(--c-panel)', border: "1px solid #334155", borderRadius: 12, padding: 24, marginBottom: 24 };
const sectionTitle = { fontSize: 17, fontWeight: 600, color: 'var(--c-text-high)', marginBottom: 12 };
const formula = {
  background: 'var(--c-bg)', border: "1px solid #334155", borderRadius: 8,
  padding: "14px 18px", fontFamily: "monospace", fontSize: 13,
  color: 'var(--c-indigo-soft)', marginBottom: 12, overflowX: "auto",
};
const example = {
  background: "rgba(16,185,129,0.06)", border: "1px solid rgba(16,185,129,0.2)", borderRadius: 8,
  padding: "12px 16px", fontSize: 12, color: 'var(--c-text-mute)', marginBottom: 12, lineHeight: 1.6,
};
const prose = { fontSize: 13, color: 'var(--c-text-mid)', lineHeight: 1.7, marginBottom: 12 };
const label = { fontSize: 11, color: 'var(--c-text-low)', textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 6 };
  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
        <div>
          <h2 style={{ fontSize: 24, fontWeight: 700, color: t.textHigh, marginBottom: 4 }}>Our Methodology</h2>
          <p style={{ fontSize: 14, color: t.textMute }}>How every number on this site is determined</p>
        </div>
        <button
          onClick={onClose}
          style={{
            background: t.border, border: "1px solid #475569", borderRadius: 8,
            color: t.textHigh, padding: "8px 16px", fontSize: 13, cursor: "pointer",
      ...
      <section style={card}>
        ...
        <div style={example}>
          Pre-war close (Aug 1, 1990): <strong style={{ color: t.textHigh }}>$428.90</strong><br />
          Bottom close (Oct 16, 1990): <strong style={{ color: t.textHigh }}>$325.40</strong><br />
          Drawdown = ((428.90 - 325.40) / 428.90) × 100 = <strong style={{ color: t.green }}>24.1%</strong>
        </div>
        <p style={prose}>
      ...
      <section style={card}>
        ...
        <div style={example}>
          Start close (Nov 27, 2002): <strong style={{ color: t.textHigh }}>$938.87</strong><br />
          End close (Mar 11, 2003): <strong style={{ color: t.textHigh }}>$800.73</strong><br />
          Change = ((800.73 - 938.87) / 938.87) × 100 = <strong style={{ color: t.red }}>-14.7%</strong>
        </div>
        <p style={prose}>
      ...
      <section style={card}>
        ...
        <div style={example}>
          NASDAQ drawdown: <strong style={{ color: t.greenSoft }}>24.1%</strong><br />
          S&P 500 drawdown: <strong style={{ color: t.indigoSoft }}>16.9%</strong><br />
          Ratio = 24.1 / 16.9 = <strong style={{ color: t.textHigh }}>1.43x</strong> — NASDAQ fell 43% harder
        </div>
        <p style={prose}>
      ...
      <section style={card}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "auto 1fr", gap: "4px 16px", marginBottom: 12, fontSize: 13 }}>
          <span style={{ color: t.greenSoft, fontWeight: 600 }}>High</span>
          <span style={{ color: t.textMid }}>3+ indices with exact daily data (Gulf War, 9/11)</span>
          <span style={{ color: t.amberStrong, fontWeight: 600 }}>Medium</span>
          <span style={{ color: t.textMid }}>Multiple indices but some approximate (Iraq War)</span>
          <span style={{ color: t.orangeSoft, fontWeight: 600 }}>Low</span>
          <span style={{ color: t.textMid }}>1-2 indices, partial records (WWII, Korea)</span>
          <span style={{ color: t.textMute, fontWeight: 600 }}>Minimal</span>
          <span style={{ color: t.textMid }}>Only S&P 500 / DJIA available (Vietnam)</span>
        </div>
        <p style={prose}>
      ...
      <section style={card}>
        ...
        <div style={example}>
          <strong style={{ color: t.textHigh }}>Post-1947:</strong> BLS / FRED series CPIAUCSL (CPI for All Urban
          Consumers, seasonally adjusted, annual averages)<br />
          <strong style={{ color: t.textHigh }}>Pre-1947:</strong> Minneapolis Fed Historical Consumer Price Index tables
        </div>
        <p style={prose}>
      ...
      <section style={card}>
        ...
        <p style={label}>Data source</p>
        <div style={example}>
          FRED series <strong style={{ color: t.textHigh }}>GFDGDPA188S</strong> — Federal Debt: Total Public Debt
        ...
        <div style={example}>
          Debt/GDP at T=0 (1941): <strong style={{ color: t.textHigh }}>42.3%</strong><br />
          Peak Debt/GDP at T+5 (1946): <strong style={{ color: t.textHigh }}>118.4%</strong><br />
          Debt/GDP at T+10 (1951): <strong style={{ color: t.textHigh }}>66.8%</strong><br />
          Δ = 118.4 - 42.3 = <strong style={{ color: t.red }}>+76.1 percentage points</strong>
          <br /><em style={{ color: t.textLow }}>(Note: Δ uses peak value for WWII since the rapid postwar GDP boom compressed the ratio by T+10)</em>
        </div>
        <p style={prose}>
      ...
      <section style={card}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
            <thead>
              <tr>
                {["Era", "Year", "CPI Multiplier", "Meaning"].map(h => (
                  <th key={h} style={{ textAlign: "left", padding: "6px 12px", color: t.textLow, fontWeight: 500, fontSize: 11, textTransform: "uppercase", letterSpacing: "0.05em", borderBottom: "1px solid #334155" }}>
                    {h}
                  </th>
                ))}
              </tr>
            ...
            <tbody>
              {[
                ...
                <tr key={era}>
                  <td style={{ padding: "6px 12px", color: t.textHigh, fontWeight: 500, borderBottom: "1px solid #1E293B" }}>{era}</td>
                  <td style={{ padding: "6px 12px", color: t.textMid, borderBottom: "1px solid #1E293B" }}>{year}</td>
                  <td style={{ padding: "6px 12px", color: t.indigoSoft, fontWeight: 600, fontFamily: "monospace", borderBottom: "1px solid #1E293B" }}>{mult}</td>
                  <td style={{ padding: "6px 12px", color: t.textMute, fontSize: 12, borderBottom: "1px solid #1E293B" }}>{meaning}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div style={example}>
          Nominal price (1941): <strong style={{ color: t.textHigh }}>$2,938</strong><br />
          CPI multiplier: <strong style={{ color: t.indigoSoft }}>21.29×</strong><br />
          Adjusted = $2,938 × 21.29 = <strong style={{ color: t.green }}>$62,550</strong> in 2024 dollars
        </div>
        <p style={prose}>
      ...
      <section style={card}>
        ...
        <div style={{ display: "grid", gap: 16 }}>
          <div>
            <p style={{ ...label, color: t.indigoSoft }}>Market Data</p>
          ...
          <div>
            <p style={{ ...label, color: t.green }}>Global Indices</p>
            <ul style={{ ...prose, paddingLeft: 20, margin: 0 }}>
          ...
          <div>
            <p style={{ ...label, color: t.amberStrong }}>Economic & Fiscal Data</p>
            <ul style={{ ...prose, paddingLeft: 20, margin: 0 }}>
          ...
          <div>
            <p style={{ ...label, color: t.amber }}>Cost of Living</p>
            <ul style={{ ...prose, paddingLeft: 20, margin: 0 }}>
