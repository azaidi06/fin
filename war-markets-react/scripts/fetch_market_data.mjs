...
const STOCK_TICKERS = [
  ...
  { av: "TSLA", yahoo: "TSLA",  google: "TSLA:NASDAQ",       symbol: "TSLA", name: "Tesla" },
  { av: "META", yahoo: "META",  google: "META:NASDAQ",       symbol: "META", name: "Meta" },
  { av: "GOOGL", yahoo: "GOOGL", google: "GOOGL:NASDAQ",     symbol: "GOOGL", name: "Alphabet" },
  { av: "AMD",  yahoo: "AMD",   google: "AMD:NASDAQ",        symbol: "AMD",  name: "AMD" },
  { av: "AAOI", yahoo: "AAOI",  google: "AAOI:NASDAQ",       symbol: "AAOI", name: "Applied Optoelectronics" },
  { av: "AXTI", yahoo: "AXTI",  google: "AXTI:NASDAQ",       symbol: "AXTI", name: "AXT Inc" },
